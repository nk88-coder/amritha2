...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Setup prediction target toggles
    ...
    predictBtn.addEventListener("click", () => {
        ...
        setTimeout(() => {
            try {
                ...
                // Calculate irradiance using the predicted temperature (tempVal)
                const scaler_t2m = MODEL_DATA.scalers.t2m;
                const t2m_scaled = tempVal * scaler_t2m.scale + scaler_t2m.min;
                ...
                // Calculate energy output: E = I * A * T (Area = 3ft x 5.5ft, Time = 1h)
                // 1 sq ft = 0.09290304 sq m. Area = 3 * 5.5 * 0.09290304 = 1.53290016 m2.
                const panelAreaM2 = 3 * 5.5 * 0.09290304;
                const energyResult = Math.round(irrResult * panelAreaM2 * 100) / 100;
                ...
                document.getElementById("energy-value").textContent = energyResult + " Wh";
